...
static const char col_primary[]        = "#FB4061";
...
static const char *upvolcmd[]   = { "/usr/bin/pactl", "set-sink-volume", "1", "+5%",     NULL };
static const char *downvolcmd[] = { "/usr/bin/pactl", "set-sink-volume", "1", "-5%",     NULL };
static const char *mutevolcmd[] = { "/usr/bin/pactl", "set-sink-mute",   "1", "toggle",  NULL };
...
static Key keys[] = {
  ...
  { MODKEY,                       XK_F2,     spawn,          {.v = downvolcmd } },
	{ MODKEY,                       XK_F4,     spawn,          {.v = mutevolcmd } },
